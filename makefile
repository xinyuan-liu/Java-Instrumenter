...
INSTRUMENTER = Tracor.Instrumenter
PARSER = Tracor.TraceParser
PREPROCESSOR = Tracor.PreProcessor
...
SOURCE_FILES = \
Tracor/PreProcessor.java Tracor/Instrumenter.java Tracor/TraceParser.java
...
Default:
	...
	@echo "make instrument/parse/preprocess ARGS=\"...\""
...
preprocess:
	java -cp bin/:$(LIBS) $(PREPROCESSOR) $(ARGS)
parse:
	java -cp bin/:$(LIBS) $(PARSER) $(ARGS)
instrument:
	java -cp bin/:$(LIBS) $(INSTRUMENTER) $(ARGS)
